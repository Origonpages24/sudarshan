...
<body>
    ...
    <div class="gallery-container container">
        <div class="gallery-main">
            <div class="gallery-navbar">
                <div class="gallery-navlist">Domestice & International</div>
                <div class="gallery-navlist">Honeymoon</div>
                <div class="gallery-navlist">Pilgrimage</div>
                <div class="gallery-navlist">Destination Wedding</div>
            </div>
        </div>
    </div>
    ...
    <div class="gallery-images-flex-box container" id="domestic" style="margin-bottom: 100px;">
    ...
    <div class="honeymoon-container" id="honeymoon">
    ...
    <div class="pilgrimage-container" id="pilgrimage">
        <div class="gallery-images-flex-box container">
            <div class="gallery-images-honeymoon gallery-images">
    ...
    <div class="destination-wedding-container" id="destination-wedding">
        <div class="gallery-images-flex-box container">
            <div class="gallery-images-honeymoon gallery-images">
   ...
   ?>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            var navItems = document.querySelectorAll(".gallery-navlist");

            // Get all the image containers
            var imageContainers = document.querySelectorAll(".gallery-images-flex-box");
            ...
            // Add click event listener to each navigation list item
            navItems.forEach(function (item, index) {
                item.addEventListener("click", function () {
                    ...
                    // Show the image container corresponding to the clicked item
                    imageContainers[index].style.display = "";
                });
            });
        });
    </script>
